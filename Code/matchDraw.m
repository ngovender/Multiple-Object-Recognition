...
image1 = 'E:\USB_1\vocab_tree_v5\vocab_tree\Deon''s code\Vocabtree2\Vocabtree2\elephant7.png';
image2 = 'E:\USB_1\vocab_tree_v5\vocab_tree\Deon''s code\Vocabtree2\Vocabtree2\elephant_test3.png';
...
matchImage1 = trainImage1;
matchImage2 = trainImage2;
...
(count)
% Hough clustering
% [originalFeatures1,originalFeatures2]= hough1(matchImage1,matchImage2, count, descriptors1,descriptors2,sizeX,sizeY);
...
num = size(matchImage1);
j = 1;



for k = 4:7
    trainImage3(j,1) = matchImage1(k,1);
    trainImage3(j,2) = matchImage1(k,2);
    trainImage3(j,3) = matchImage1(k,3);
    trainImage3(j,4) = matchImage1(k,4);
    
    trainImage4(j,1) = matchImage2(k,1);
    trainImage4(j,2) = matchImage2(k,2);
    trainImage4(j,3) = matchImage2(k,3);
    trainImage4(j,4) = matchImage2(k,4);
    j = j+1
end
j
